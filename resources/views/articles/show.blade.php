        ...
        {{-- <div id="animation-carousel" class="relative w-full mx-auto max-w-screen-xl" data-carousel="static">
               ...
               <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                   <div class="duration-200 ease-linear" data-carousel-item style="display: block;">
                       <img src="{{URL::asset('./carousel/ข่าวสาร.png')}}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                   </div>
               </div>
           </div> --}}
                ...
                <header class="mb-4 lg:mb-6 not-format">
                    <address class="flex items-center mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            ...
                            <div>
                                <a href="#" rel="author"
                                    class="text-xl font-bold text-gray-900 dark:text-white"> เขียนโดย : บริษัท อทิตยา 2017 จำกัด</a>
