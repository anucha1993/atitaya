...
<nav class="bg-blue-800 border-gray-200 dark:bg-gray-900" style="z-index: 90000">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
        <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            {{-- <span class="self-center text-xl text-header font-semibold whitespace-nowrap dark:text-white">
                ...
                <p id="text-menu-p" class="self-center text-1xl  font-semibold text-blue-900">อาทิตยา 2017 จำกัด
                </p>
            </span> --}}
        </a>
        ...
        <div class="hidden w-full md:block md:w-auto  " id="navbar-default">
            <ul
                class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-blue-800 md:dark:bg-blue-900 dark:border-gray-700">
                <li>
                    <a href="{{ url('home') }}"
